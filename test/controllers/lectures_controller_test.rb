...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference("Lecture.count") do
      post lectures_url, params: { lecture: { description: @lecture.description, name: @lecture.name, section_id: @lecture.section_id, url: @lecture.url } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { description: @lecture.description, name: @lecture.name, section_id: @lecture.section_id, url: @lecture.url } }
